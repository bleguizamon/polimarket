...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './entrega.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTREGA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENTREGA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENTREGA actions', async () => {
      const arg = { id: 5892 };
    ...
    it('dispatches UPDATE_ENTREGA actions', async () => {
      const arg = { id: 5892 };
    ...
    it('dispatches PARTIAL_UPDATE_ENTREGA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENTREGA actions', async () => {
      const arg = 42666;
