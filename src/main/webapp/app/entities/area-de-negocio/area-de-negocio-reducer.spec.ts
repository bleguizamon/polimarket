...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AREADENEGOCIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AREADENEGOCIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AREADENEGOCIO actions', async () => {
      const arg = { id: 24535 };
    ...
    it('dispatches UPDATE_AREADENEGOCIO actions', async () => {
      const arg = { id: 24535 };
    ...
    it('dispatches PARTIAL_UPDATE_AREADENEGOCIO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AREADENEGOCIO actions', async () => {
      const arg = 42666;
