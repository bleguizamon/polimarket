...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './vendedor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VENDEDOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VENDEDOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VENDEDOR actions', async () => {
      const arg = { id: 6161 };
    ...
    it('dispatches UPDATE_VENDEDOR actions', async () => {
      const arg = { id: 6161 };
    ...
    it('dispatches PARTIAL_UPDATE_VENDEDOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VENDEDOR actions', async () => {
      const arg = 42666;
