...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOVIMIENTOSTOCK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MOVIMIENTOSTOCK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MOVIMIENTOSTOCK actions', async () => {
      const arg = { id: 1605 };
    ...
    it('dispatches UPDATE_MOVIMIENTOSTOCK actions', async () => {
      const arg = { id: 1605 };
    ...
    it('dispatches PARTIAL_UPDATE_MOVIMIENTOSTOCK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MOVIMIENTOSTOCK actions', async () => {
      const arg = 42666;
