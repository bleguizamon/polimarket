...
export const TareaDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/tarea${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="polimarketApp.tarea.delete.question">
        <Translate contentKey="polimarketApp.tarea.delete.question" interpolate={{ id: tareaEntity.id }}>
