...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVENTARIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVENTARIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVENTARIO actions', async () => {
      const arg = { id: 30465 };
    ...
    it('dispatches UPDATE_INVENTARIO actions', async () => {
      const arg = { id: 30465 };
    ...
    it('dispatches PARTIAL_UPDATE_INVENTARIO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVENTARIO actions', async () => {
      const arg = 42666;
