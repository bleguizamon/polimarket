...
public class ProductoTestSamples {
    ...
    public static Producto getProductoSample1() {
        return new Producto().id(1L).nombre("nombre1").cantidadDisponible(1);
    }

    public static Producto getProductoSample2() {
        return new Producto().id(2L).nombre("nombre2").cantidadDisponible(2);
    }
    ...
    public static Producto getProductoRandomSampleGenerator() {
        return new Producto()
            ...
            .cantidadDisponible(intCount.incrementAndGet());
    }
}
